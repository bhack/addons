...
### Code example
* It is required to contribute a code example in the docstring when adding simple new features.
* It is strongly suggested to expand or contribute new [tutorals](https://github.com/tensorflow/addons/blob/master/docs/tutorials/README.md) for more complex features that are hard to be expressed only in the docstring.
